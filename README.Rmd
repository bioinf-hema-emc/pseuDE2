...
Design equations: \* Unpaired analysis: '\~ + com_group' \* Paired analysis: '\~ + pair_group + com_group' }
...
Since the same patients are present in both conditionA and conditionB, when can perform a paired comparison by setting paired = T.
This corrects for any biological variability wihin the patients between the conditions.
