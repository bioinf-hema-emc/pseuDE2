...
Since the same patients are present in both condition A and condition B, when can perform a paired comparison by setting `paired = T`.
This corrects for any biological variability within the patients between the conditions.
